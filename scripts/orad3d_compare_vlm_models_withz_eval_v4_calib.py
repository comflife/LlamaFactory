...
python scripts/orad3d_compare_vlm_models_withz_eval_v4.py \
  ...
  --adapter sft_refine=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2_refine/checkpoint-2610 \
  --adapter sft=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2_8/checkpoint-2610 \
  --adapter orpo=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/orpo2/checkpoint-2610 \
...
python scripts/orad3d_compare_vlm_models_withz_eval_v4.py \
  --base-model Qwen/Qwen3-VL-2B-Instruct \
  --adapter sft_refine=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2_refine/checkpoint-4698 \
  --adapter sft=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2_refine/checkpoint-5220 \
  --adapter orpo=/home/work/datasets/bg/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2_8/checkpoint-4698 \
  ...
  --cache-dir /home/work/byounggun/.cache/hf \
  --use-sharegpt-format --temperature 1e-6 \
  --hit-threshold 2.0 --frames-per-point 7 --auto-frames-per-point --failure-threshold 2.0 --projection calib
"""
...
def _project_points_with_calib(points: List[List[float]], calib: Calib) -> List[Tuple[float, float]]:
    ...
    return project(points, Rt, t_inv)
...
def _make_composite(
    *,
    ...
    model_points_overlay = [
        (mo.name, mo.trajectory_points, color) for mo, color in model_outputs
    ]
    overlay = _render_overlay_multimodel(
        image=image,
        header=header,
        gt_points=gt_points,
        model_points=model_points_overlay,
        forward_axis=forward_axis,
        flip_lateral=flip_lateral,
