...
CUDA_VISIBLE_DEVICES=0 python scripts/orad3d_infer_vlm_trajectory_samples_orpo.py --base-model Qwen/Qwen3-VL-2B-Instruct --adapter /data3/byounggun/saves/orad3d/qwen3-vl-2b/lora/orpo/checkpoint-364 --orad-root /data3/ORAD-3D --split validation --image-folder image_data --num-samples 5 --out-dir /home/byounggun/LlamaFactory/orad3d_infer_samples_orpo --trust-remote-code --use-sharegpt-format --temperature 0
python scripts/orad3d_infer_vlm_trajectory_samples_orpo.py --base-model Qwen/Qwen3-VL-2B-Instruct --adapter /data3/byounggun/saves/orad3d/qwen3-vl-2b/lora/orpo/checkpoint-364 --orad-root /data3/ORAD-3D --split validation --image-folder image_data --num-samples 5 --out-dir /home/byounggun/LlamaFactory/orad3d_infer_samples_orpo --trust-remote-code --use-sharegpt-format --temperature 0


Example (explicit images):
    python scripts/orad3d_infer_vlm_trajectory_samples.py \
        --base-model Qwen/Qwen3-VL-2B-Instruct \
        --adapter /data3/byounggun/saves/orad3d/qwen3-vl-2b/lora/sft_v2/checkpoint-819 \
        --image /data3/ORAD-3D/validation/<seq>/image_data/<timestamp>.png \
        --image /data3/ORAD-3D/validation/<seq>/image_data/<timestamp>.png \
        --out-dir /home/byounggun/LlamaFactory/orad3d_infer_samples \
        --trust-remote-code
"""
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--cache-dir", type=str, default="/home/byounggun/.cache/hf")
